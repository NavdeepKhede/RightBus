...
class Bus {
  ...
  async getAllBuses() {
    try {
      const query = 'SELECT buses.id as id,routes.id as route_id, buses.occupancy, buses.totalSeats, buses.day_of_working FROM buses JOIN routes ON buses.route_id = routes.id;';
